...
to_do = ToDo.create(to_do: "add better relationships", do_date: "12/21/2022", project: Project.find_by(id:1))
note = Note.create(note_content: "Might need to spend some time planning out relationships better", project: Project.find_by(id:1))